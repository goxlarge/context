...
//
//	q=the cocktaildb query
//	timeout=a timeout for the request, in time.Duration format
//
// https://mixedanalytics.com/blog/list-actually-free-open-no-auth-needed-apis/
// For example, http://localhost:8080/search?s=margarita&timeout=1s serves the
// first few search results for "margarita" or a "deadline exceeded" error
